...
OI::OI() {
	...
	SmartDashboard::PutData("FireCannons", new FireCannons());


    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

    autoGear.reset(new JoystickButton(gamePad.get(),2));
    autoGear->WhenPressed(new AutoGearPlacement());
